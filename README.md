...
### 개요
Kream 은 한정판 상품을 판매자와 구매자 간 중개업을 하는 거래 플랫폼입니다.
Maker가 판매 또는 구매를 원하는 가격을 제시하고, Taker가 해당 가격을 수락하는 식으로 이루어집니다.
주 거래 품목은 의류나 패션 잡화 등의 한정판 상품입니다. 또한 단순한 거래 중개 플랫폼에서 벗어나 고객들이 상품과 콘텐츠를 기반으로 상호 소통할 수 있는 멀티 플랫폼을 지향하고 있습니다.
이렇게 주식시장의 거래 방식을 이용하는 이커머스 서비스와 소셜 기능이 합쳐져있는 kream 이 첫 프로젝트를 경험해 보기에 좋은것 같아 해당 서비스를 클론코딩 하기로 했습니다.
